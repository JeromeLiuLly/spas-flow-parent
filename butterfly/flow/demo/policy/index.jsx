...
class Policy extends Component {
  ...
  render() {
    const {showNodeInfo, currentNodeIndex,showModelInfo,showSubFlowInfo} = this.state;
    return (
      <div className='policy-page'>
        <div className='operate-bar'>
          ...
          <div className='operate-item'>
            <Button onClick = {this.sendFlowRequest}>模拟工作流请求</Button>
          </div>
        </div>
        {
            showModelInfo ? <span>{this.renderFlowModel()}</span> :<></>
        }
        {
